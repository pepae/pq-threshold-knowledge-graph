...
166 nodes, 449 typed edges, 18 source PDFs. It works three ways at once.
...
Start at `desiderata/D14.md` (epoch-free batching, the requirement that separates
the field), or `open-problems/` for what is unsolved.
...
nodes are hidden by default because they are 63 of the 166; re-enable them from
...
| `technique` | 26 | noise flooding, KH-PPRF, zero-sharing masks, vector commitments, LaBRADOR |
